...
function Footer({ onButtonClick }) {
  ...
  return (
    <footer className="bg-[#0f1419] text-white py-16 px-6 lg:px-8 border-t border-[#2a3142]">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <button 
                ...
                className="w-12 h-12 rounded-xl bg-[#252b3a] hover:bg-violet-600 transition-all flex items-center justify-center group"
        ...
        <div className="border-t border-[#2a3142] pt-10">
